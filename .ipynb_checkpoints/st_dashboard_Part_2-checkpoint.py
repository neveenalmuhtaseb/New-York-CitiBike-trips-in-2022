...
### Create the dual axis line chart page ###
    ...
    st.markdown("Typical pattern (in many cities, confirmed by your pattern): Usage in summer peak → 100% baseline. Usage in winter low → ~30-50% of peak (sometimes lower, depending on snowfall, wind, holiday season")
